...
**Nota:** El módulo de visualización ya está vinculado a sesiones protegidas. Además, el backend ya está configurado para entregar datos a clientes autenticados de forma segura.
